...
\centering
\mbox{
\subfigure[]{\includegraphics[width=0.48\linewidth]{figures/nwInf_cumulative_forPaper.pdf}}
\subfigure[]{\includegraphics[width=0.48\linewidth]{figures/motif_cumulative_forPaper.pdf}}
}
...
regulons (annotated in \rdb~or \tmsamp{RegPrecise}
